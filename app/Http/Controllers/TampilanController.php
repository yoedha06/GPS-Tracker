...
class TampilanController extends Controller
{
    ...
    public function grafikadmin(Request $request)
    {
        ...
        if ($selectedDevice) {
            ...
            // Jika tidak ada perangkat yang dipilih, tambahkan kondisi where untuk hanya menampilkan riwayat dari perangkat saat ini
            $query->whereHas('device', function ($query) {
                // Tidak perlu kondisi where untuk user_id
            });
        }
