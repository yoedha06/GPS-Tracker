            ...
            Object.values(devicePolylines).forEach(polyline => {
                ...
                polyline.getLatLngs().forEach(point => {
                    ...
                    if (data && data.speeds !== null && data.speeds !== undefined) {
                        ...
                        if (speed <= 20) {
                            color =
                                'green'; // If speed is less than or equal to 20 km/h, color is green
                            weight = 10; // Set polyline weight to wide
                        } else if (speed <= 40) {
                            color =
                                'yellow'; // If speed is between 21 and 40 km/h, color is yellow
                ...
                if (accuracy <= 10) {
                    ...
                    opacity =
                        0.6; // Set opasitas ke 0.5 jika akurasi di antara 11 dan 20 (sedang transparan)
                } else {
