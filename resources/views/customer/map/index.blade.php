...
var start = L.latLng(historyData[0].latitude, historyData[0].longitude); // Mengambil koordinat titik awal dari data pertama dalam historyData
var end = L.latLng(historyData[historyData.length - 1].latitude, historyData[historyData.length - 1].longitude); // Mengambil koordinat titik akhir dari data terakhir dalam historyData
