            ...
            <div class="card-body">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="avatar avatar-2xl">
                        <img src="http://smkn11bdg.sch.id/fotoGuru/1620289429.jpg" alt="Avatar"  style="width: 150px; height: 200px;">
                    </div>

                    <h3 class="mt-3">PARWANTO DESU</h3>
                    <p class="text-small">KESISWAAN</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <form action="#" method="get">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Your Name" value="Parwanto, S.Pd" fdprocessedid="pczq">
                    </div>
                    <div class="form-group">
                        <label for="email" class="form-label">Email</label>
                        <input type="text" name="email" id="email" class="form-control" placeholder="Your Email" value="ganjelto.toto@example.net" fdprocessedid="cgz6v">
                    </div>
                    <div class="form-group">
